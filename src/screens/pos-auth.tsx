...
const PosAuth = () => {
    ...
    return (
        ...
        <div className='grid grid-cols-2 min-h-screen'>
            <div className='h-screen bg-[url(/assets/auth2.jpeg)] bg-center bg-cover p-10'>
                <button
            ...
            <div className='p-10 flex justify-center items-center'>
                <form action="" className='flex flex-col gap-7 w-full'>
                    <div className='flex flex-col'>
                        <h1 className='text-3xl text-primary400'>Login</h1>
                    ...
                    <div className='flex items-center justify-between'>
                        <button
                            className="cursor-pointer rounded-md hover:shadow-xl bg-linear-to-r from-primary400 to-primary500 py-2 px-10 text-white">
                            sign in
                        </button>
